...
#define vec_ring_index(self,index)  ( ( index + (self)->max ) % (self)->max )
#define vec_ring_item_index(self,i) vec_ring_index(self, (self)->head - (self)->size + (i) + 1)
#define vec_ring_head_index(self)   (self)->head
#define vec_ring_tail_index(self)   vec_ring_item_index(self, 0)
#define vec_ring_item(self,i)       vec_ring_buf(self)[vec_ring_item_index(self,i)]
